...
/**
 * Corpo da pagina do board.
 *
 * Era o `page.tsx` inteiro. Virou client component separado quando a busca
 * dos dados foi pro servidor: o `page.tsx` agora e Server Component, busca
 * o `get_board_data` e injeta o resultado no `fallback` do SWRConfig — ver
 * o comentario la.
 *
