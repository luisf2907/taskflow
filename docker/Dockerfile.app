...
ARG NEXT_PUBLIC_AUTH_MODE=standard
ARG NEXT_PUBLIC_GITHUB_OAUTH=false
ARG NEXT_PUBLIC_OBS_DRIVER=console
...
ENV NEXT_PUBLIC_GITHUB_OAUTH=$NEXT_PUBLIC_GITHUB_OAUTH
ENV NEXT_PUBLIC_OBS_DRIVER=$NEXT_PUBLIC_OBS_DRIVER
